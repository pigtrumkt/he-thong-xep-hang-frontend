...
export default function AccountsManagementPage() {
  ...
  const handleToggleStatus = async (accountId: number, newStatus: number) => {
    const res = await apiPost(`/accounts/${accountId}/statusCentral`, {
      status: newStatus,
    });
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            <option value="1">Super Admin (root)</option>
            <option value="2">Super Admin</option>
            <option value="11">Admin cơ quan</option>
          </select>
          <select
            value={statusFilter}
            ...
            >
              ...
              <td className="px-4 py-2">
                <div className="flex items-center gap-2">
                  ...
                  {hasAccess({
                    allowedRoles: [RoleEnum.SUPER_ADMIN_ROOT],
                    allowedPermissions: [PermissionEnum.ACCOUNT_DELETE_SUPER],
                  }) && (
                    <button
                      title="Xoá"
